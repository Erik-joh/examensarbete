defmodule XarbWeb.ListLiveTest do
  ...
  describe "Index" do
    ...
    test "updates list in listing", %{conn: conn, list: list} do
      ...
      assert html =~ "some updated titel"
    end
