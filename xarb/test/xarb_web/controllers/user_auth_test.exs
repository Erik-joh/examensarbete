defmodule XarbWeb.UserAuthTest do
  use XarbWeb.ConnCase, async: true

  alias Xarb.Accounts
  alias XarbWeb.UserAuth
  import Xarb.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, XarbWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      XarbWeb.Endpoint.subscribe(live_socket_id)
