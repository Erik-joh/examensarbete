defmodule XarbWeb.Router do
  use XarbWeb, :router

  import XarbWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {XarbWeb.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: XarbWeb.Telemetry
    end
  end
  ...
  scope "/", XarbWeb do
    ...
    live "/currentList", ListLive.Current_list
